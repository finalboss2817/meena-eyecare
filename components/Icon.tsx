...
type IconName = 'cart' | 'wishlist' | 'user' | 'trash' | 'edit' | 'plus' | 'minus' | 'eye' | 'chevron-left' | 'logout' | 'dashboard' | 'products' | 'tools' | 'close';
...
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  // FIX: Corrected typo 'strokeLinecan' to 'strokeLinecap'.
